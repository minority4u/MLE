...
public class MainFrame extends JFrame {
    ...
    public void run() {
        ...
        while (!stop) {
            ...
            if (xSchlaeger >= BALL_X_MAX) {
                xSchlaeger = BALL_X_MAX - 1;
            }
            ...
            if (xBall >= BALL_X_MAX || xBall < 1) {
                xV = -xV;
            }
            if (yBall > BALL_Y_MAX || yBall < 1) {
                yV = -yV;
            }
            ...
            if (yBall == BALL_Y_MAX) {
                ...
                if (round % PRINT_OVERVIEW_EVERY_N_STEPS == 0) {
                    System.out.println("Round: " + round + " Score: " + score +
                            " (" + (int) ((100 / PRINT_OVERVIEW_EVERY_N_STEPS) * score) + "%)");
                    score = 0;
                }
            }
