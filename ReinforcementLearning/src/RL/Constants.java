...
public class Constants {
    ...
    public static double ALPHA = 0.1; // lernrate
    public static double GAMMA = 0.5; // Faktor wie viel Schritte der lerneffekt zurückreicht
    ...
    public static double PRINT_OVERVIEW_EVERY_N_STEPS = 1000;
